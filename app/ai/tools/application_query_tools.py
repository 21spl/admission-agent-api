...
from app.core.factories import get_application_history_service, get_application_service
...
def build_application_query_tools(db, application_id) -> list[FunctionTool]:
    ...
    async def get_my_application_status_history() -> list[dict]:
        ...
        history_list = await application_history_service.get_history_for_officer(
            application_id
        )
        return [
            {
