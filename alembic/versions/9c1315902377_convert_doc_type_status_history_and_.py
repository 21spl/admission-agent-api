...
down_revision: str | Sequence[str] | None = "8b5da9329247"
...
def upgrade() -> None:
    ...
    op.execute(
        "UPDATE application_status_history SET old_status = NULL WHERE old_status = 'NONE'"
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "UPDATE application_status_history SET old_status = 'NONE' WHERE old_status IS NULL"
    )
