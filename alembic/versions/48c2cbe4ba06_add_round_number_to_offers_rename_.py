...
down_revision: str | Sequence[str] | None = "4fe002e24b0a"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_offers_round_number"), "offers", ["round_number"], unique=False
    )
    op.create_unique_constraint(
        "uq_offer_application_round", "offers", ["application_id", "round_number"]
    )
