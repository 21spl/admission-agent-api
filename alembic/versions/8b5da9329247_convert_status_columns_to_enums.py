...
down_revision: str | Sequence[str] | None = "b83ce111335b"
...
def upgrade() -> None:
    ...
    validation_status_enum = sa.Enum(
        "PENDING", "VALID", "INVALID", name="validation_status"
    )
    loan_status_enum = sa.Enum(
        "NOT_REQUESTED", "PENDING", "APPROVED", "REJECTED", name="loan_status"
    )
    offer_status_enum = sa.Enum(
        "PENDING", "ACCEPTED", "REJECTED", "EXPIRED", name="offer_status"
    )
